  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragOver ? 'border-brand-cyan bg-brand-cyan/5 scale-[1.01]' : 'border-border hover:border-brand-cyan/50 hover:bg-surface-light/50'}
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted mt-1">Supports .xlsx, .xls, and .csv files (up to 50 MB)</p>
          </div>
        </div>
      )}
    </div>
