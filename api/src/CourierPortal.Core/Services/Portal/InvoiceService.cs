...
using Azure.Core;
using CourierPortal.Core.Dtos.Common;
using CourierPortal.Core.Dtos.Invoices;
using CourierPortal.Core.Dtos.Runs;
...
{
    public class InvoiceService(TimeZoneService timeZoneService, RunService runService, IDbContextFactory<DespatchContext> contextFactory) : BaseService(contextFactory)
    {
